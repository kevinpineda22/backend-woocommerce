...
//
// ⚠️ Este archivo está duplicado en `ecommerce/shared/paymentMethods.js` (ESM)
// y debe mantenerse en sync. `utils/paymentMethods.test.js` falla si divergen.
//
...
const CREDITO_LABEL = "Cliente Crédito";
...
const COD_MODE_EMPTY = ["na", "n/a", "no_aplica", "noaplica", "none"];

const COD_MODE_META_KEY = "_billing_cod_payment_mode";
...
function getCodPaymentMode(orderOrMeta) {
...
function resolvePaymentLabel(orderOrMeta) {
