...
const masterRoutes = [
  ...
  {
    path: "/gestion-equipo",
    label: "Gestión de Equipo (Líderes)",
  ...
  // === ECOMMERCE ===
  {
    ...
    label: "Pedidos Ecommerce",
    group: "Ecommerce",
  },
  {
    path: "/ecommerce/picker",
    label: "Vista Picker",
    group: "Ecommerce",
  },
  {
    path: "/ecommerce/analitica",
    label: "Analítica Pickers",
    group: "Ecommerce",
  },
  {
    path: "/ecommerce/gestion-pickers",
    label: "Gestión Pickers",
    group: "Ecommerce",
  },
  {
    path: "/ecommerce/auditor",
    label: "Vista Auditor",
    group: "Ecommerce",
  },
  {
    path: "/gestor-ecommerce",
    label: "Gestor Ecommerce",
    group: "Ecommerce",
  },
  {
  ...
  { path: "/epp", label: "EPP (Equipos de Protección)", group: "Dotación" },
