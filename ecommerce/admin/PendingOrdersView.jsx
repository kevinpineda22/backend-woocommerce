    ...
    displayedOrders.forEach((order) => {
      ...
      if (!groups[dateKey]) {
        ...
        if (orderDay.getTime() === today.getTime()) {
          ...
          label = orderDay.toLocaleDateString("es-CO", {
            weekday: "long",
            day: "numeric",
            month: "long",
          });
  ...
  return (
    <>
      ...
      {loading && orders.length === 0 ? (
        ...
        <div className="pedidos-admin-orders-grouped">
          {displayedOrders.length === 0 ? (
            ...
            groupedByDate.map(([dateKey, { label, orders: dateOrders }]) => (
              <div key={dateKey} className="pa-date-group">
