  ...
  return (
    <div className="ec-picker-main-layout">
      ...
      <header className="ec-picker-sticky-header">
        <div className="ec-header-top"><div className="ec-order-info"><span className="ec-label-sm">Sesión Activa</span><span className="ec-order-id">#{sessionData.session_id.slice(0,6)}</span></div><div style={{textAlign:'right'}}><span className="ec-label-sm">{sessionData.orders_info.length} Pedidos</span><div style={{fontWeight:'bold'}}>{doneItems.length} / {sessionData.items.length} Items</div></div></div>
